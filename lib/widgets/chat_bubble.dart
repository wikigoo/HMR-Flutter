...
class ChatBubble extends StatelessWidget {
  const ChatBubble({super.key, required this.message, required this.onCopy});
            ...
            child: ConstrainedBox(
              ...
              child: _GlassBubble(
                ...
                borderRadius: const BorderRadius.only(
                  ...
                  bottomLeft: Radius.zero, // sharp tail points at the AI
                ),
                fill: AppTheme.bubbleAiFill,
                border: AppTheme.bubbleAiBorder,
